...
public class MapChangelistsToNewFailuresMain {
  public static void main(String[]args)throws Exception {
    ...
    Map<String, Map<String, Integer>> changelist_to_failures = get_new_failures_by_changelist(cls, runs,
  ...
  static Map<String, Map<String, Integer>> get_new_failures_by_changelist(ChangelistSourceFiles cls,
